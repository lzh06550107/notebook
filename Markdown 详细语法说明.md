...
<h2 id="acknowledgement">声明</h2>

该文档主要拷贝自 <https://gitcafe.com/riku/Markdown-Syntax-CN/raw/master/syntax.md> ，感谢 [leafy7382][] 协助翻译，[hlb][]、[Randylien][] 帮忙润稿，[ethantw][] 的[汉字标准格式・CSS Reset][]， [WM][] 回报文字错误。
感谢 [fenprace][]，[addv][]。
